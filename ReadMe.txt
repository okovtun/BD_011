...
7. Написать функцию ??? pop_row_back(???), которая удаляет строку в конец двумерного динамического массива;
8. Написать функцию ??? pop_row_front(???), которая удаляет строку в начало двумерного динамического массива;
9. Написать функцию ??? erase_row(???), которая удаляет строку из двумерный динамического массив по указанному индексу;


10. Написать функцию ??? push_col_back(???), которая добавляет столбик в конец двумерного динамического массива;
11. Написать функцию ??? push_col_front(???), которая добавляет столбик в начало двумерного динамического массива;
12. Написать функцию ??? insert_col(???), которая вставляет столбик в двумерный динамического массив по указанному индексу;
